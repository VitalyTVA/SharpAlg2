...
namespace SharpAlg.Geo {
    internal static class PrimitiveOperations {
        internal static Point Offset(this IBuilder builder, Point p, Point offset) {
            return new Point(builder.Add(p.X, offset.X), builder.Add(p.Y, offset.Y));
        }
        internal static Point Invert(this IBuilder builder, Point p) {
            return new Point(builder.Minus(p.X), builder.Minus(p.Y));
        }
        internal static Circle Offset(this IBuilder builder, Circle c, Point offset) {
            var center = builder.Offset(c.Center, offset);
            return new Circle(center.X, center.Y, c.R);
        }
        internal static Point Middle(this IBuilder builder, Point p1, Point p2) {
            return new Point(builder.Mean(p1.X, p2.X), builder.Mean(p1.Y, p2.Y));
        }
        static Expr Mean(this IBuilder builder, Expr a, Expr b) => builder.Build((x, y) => (x + y) / 2, a, b);

        internal static Circle MakeCircle(this IBuilder builder, Point p1, Point p2) {
            var r = builder.Build((x1, x2, y1, y2) => ((x1 - x2) ^ 2) + ((y1 - y2) ^ 2), p1.X, p2.X, p1.Y, p2.Y);
            return new Circle(p1.X, p1.Y, r);
        }
        internal static Point MakePoint(this IBuilder builder, char name) {
            if(!char.IsUpper(name))
                throw new InvalidOperationException();
            return new Point(Param(name + "x"), Param(name + "y"));
        }
        internal static Line MakeLine(this IBuilder builder, Point p1, Point p2) {
        ...
        internal static Point IntersectLines(this IBuilder builder, Line l1, Line l2) {
        ...
        internal static Tuple<Point, Point> IntersectLineAndCircle(this IBuilder builder, Line l, Circle c) {
        ...
        internal static Tuple<Point, Point> IntersectCircles(this IBuilder builder, Circle c1, Circle c2) {
        ...
        internal static Expr TangentBetweenLines(this IBuilder builder, Line l1, Line l2) {
            return builder.Build((A1, B1, A2, B2) => (A1 * B2 - A2 * B1) / (A1 * A2 + B1 * B2), l1.A, l1.B, l2.A, l2.B);
        }
        internal static Expr CotangentBetweenLine(this IBuilder builder, Line l1, Line l2) {
            return builder.Build((A1, B1, A2, B2) => (A1 * A2 + B1 * B2) / (A1 * B2 - A2 * B1), l1.A, l1.B, l2.A, l2.B);
        }
        internal static Expr GetLineYByX(this IBuilder builder, Line l, Expr x) {
            return builder.Build((A, B, C, X) => -(A * X + C) / B, l.A, l.B, l.C, x);
        }
        internal static Tuple<Expr, Expr> SolveQuadraticEquation(this IBuilder builder, Expr a, Expr b, Expr c) {
