...
namespace SharpAlg.Geo {
    public static class PrimitiveOperations {
        public static Point Offset(this Builder builder, Point p, Point offset) {
            return new Point(builder.Add(p.X, offset.X), builder.Add(p.Y, offset.Y));
        }
        public static Point Invert(this Builder builder, Point p) {
            return new Point(builder.Minus(p.X), builder.Minus(p.Y));
        }
        public static Circle Offset(this Builder builder, Circle c, Point offset) {
